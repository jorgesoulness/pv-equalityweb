    ...
    protected function render_as_tabs( $target ){
        ...
        <<?php echo $navigation_wrap_tag;?> id="<?php echo esc_attr( $this->tab_id ); ?>" class="<?php echo esc_attr( $this->get_class_for_tabs () );?> <?php echo esc_attr( $justified );?>" role="tablist">
            ...
            foreach ($rows as $row):
                ...
                ?>
                <<?php echo $navigation_element_tag;?> role="presentation" class="<?php echo esc_attr( $disabled ) . ' ' . esc_attr( $active ) . ' ' . esc_attr( $tab_classes );?>">
                    <a href="#<?php echo $nav_name ?>" class="<?php echo esc_attr( $tab_link_class ) . ' ' . esc_attr( $disabled ); ?>" aria-controls="<?php echo esc_attr( $nav_name ) ?>" role="<?php echo esc_attr( $this->get_attr_for_tabs() );?>" <?php echo $this->get_data_attr();?>="<?php echo esc_attr( $this->get_attr_for_tabs() );?>"><?php echo $content['title'];?></a>
            ...
            foreach ($rows as $row):
                ...
                <<?php echo $navigation_element_tag;?> role="presentation" class="<?php echo esc_attr( $disabled ) . ' ' . esc_attr( $active ) . ' ' . esc_attr( $tab_classes );?>">
                    <a href="#<?php echo $nav_name ?>" aria-controls="<?php echo $nav_name ?>"
						class="<?php echo esc_attr( $tab_link_class ) . ' ' . esc_attr( $disabled ); ?>"
