...
'CRED_Ajax_Handler_Submit_Form' => dirname( __FILE__ ) . '/controllers/ajax/handler/submit_form.php',
...
'CRED_Api_Handler_Current_User_Can_Use_Any_Attachment' => dirname( __FILE__ ) . '/controllers/api/handler/current_user_can_use_any_attachment.php',
...
'OTGS\Toolset\CRED\Controller\CommentsManager' => dirname( __FILE__ ) . '/controllers/comments_manager.php',
'OTGS\Toolset\CRED\Controller\CommentsManager\Association' => dirname( __FILE__ ) . '/controllers/comments_manager/association.php',
'OTGS\Toolset\CRED\Controller\CommentsManager\Repository' => dirname( __FILE__ ) . '/controllers/comments_manager/repository.php',
'OTGS\Toolset\CRED\Controller\CommentsManager\ICommentsManager' => dirname( __FILE__ ) . '/controllers/comments_manager/interface.php',
'OTGS\Toolset\CRED\Controller\CommentsManager\Post' => dirname( __FILE__ ) . '/controllers/comments_manager/post.php',
'OTGS\Toolset\CRED\Controller\CommentsManager\User' => dirname( __FILE__ ) . '/controllers/comments_manager/user.php',
...
'OTGS\Toolset\CRED\Controller\Frontend\MediaManager' => dirname( __FILE__ ) . '/controllers/frontend/media_manager.php',
...
'OTGS\Toolset\CRED\Controller\Upgrade\Routine2040000DbUpgrade' => dirname( __FILE__ ) . '/controllers/upgrade/routine_2040000_db_upgrade.php',
...
'OTGS\Toolset\CRED\Model\Forms\DataFactory' => dirname( __FILE__ ) . '/models/forms/data_factory.php',
...
'OTGS\Toolset\CRED\Model\Wordpress\Media' => dirname( __FILE__ ) . '/models/wordpress/media.php',
